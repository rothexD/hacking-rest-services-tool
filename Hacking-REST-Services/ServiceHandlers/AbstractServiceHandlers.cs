...
namespace Hacking_Rest_SqlInjetor.ServiceHandlers
{
    public abstract class AbstractServiceHandler 
    {
        ...
        protected static IEnumerable<FormData> GetFormsOfHtmlDocument(HtmlDocument document, string uri)
        {
            ...
            foreach (var formNode in formNodes)
            {
                ...
                form.InputFields = form.InputFields.Concat(GetButtonChildren(formNode));
                forms.Add(form);
            }
        ...
        private static IEnumerable<SelectInformation> GetSelectChildren(HtmlNode parent)
        {
        ...
        // to get specific key value pairs
        private static IEnumerable<InputInformation> GetInputChildren(HtmlNode parent)
        {
        ...
        private static IEnumerable<InputInformation> GetButtonChildren(HtmlNode parent)
        {
